package estacionamiento.infraestructura.excepcion;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
	 ...
	 private static final Logger LOGGER_ERROR = LoggerFactory.getLogger(ManejadorError.class);
	    ...
	    public ManejadorError() {
	        CODIGOS_ESTADO.put(ExcepcionPlacaIniciaConA.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
	        CODIGOS_ESTADO.put(ExcepecionNoHayCeldasDisponibles.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
	    }
